        ...
        { label: 'Brochure 6' },
        {
          ...
          children: [
            ...
            },
            {
              label: 'OB & GYN',
              children: [
                { label: 'การคลอดและการช่วยคลอด (D010)' },
                { label: 'การคลอดและการช่วยคลอด+ทำหมัน (D011)' },
                { label: 'การผ่าตัดทำหมันหญิง (D030)' },
                { label: 'การผ่าตัดคลอด (D020)' },
                { label: 'การผ่าตัดคลอด+ทำหมัน (D021)' },
                { label: 'การผ่าตัดเนื้องอกมดลูกแบบเปิด (D051)' },
                { label: 'การผ่าตัดเนื้องอกมดลูกด้วยกล้อง (D052)' },
                { label: 'การผ่าตัดเนื้องอกรังไข่แบบเปิด (D061)' },
                { label: 'การผ่าตัดเนื้องอกรังไข่ด้วยกล้อง (D062)' },
                { label: 'การผ่าตัดมดลูกทางช่องคลอดด้วยกล้อง (D042)' },
                { label: 'เด็กแรกเกิด_เด็กปกติ (D980)' },
                { label: 'เด็กแรกเกิด_เด็กป่วย (D990)' },
              ],
            },
            {
            ...
            },
            {
              ...
              children: [
                ...
                { label: 'การผ่าตัดไส้เลื่อนข้างเดียว (A021)' },
                { label: 'การผ่าตัดไส้เลื่อนขาหนีบข้างเดียวด้วยกล้อง (A023)' },
                { label: 'การผ่าระบายหนอง (A041)' },
                { label: 'การผ่าโพรงฝีคัณฑสูตร (A042)' },
              ],
            },
            {
              label: 'Surg_Ped',
            ...
            },
            {
              ...
              children: [
                ...
                { label: 'การผ่าตัดนิ่วท่อไต (E014)' },
                { label: 'การผ่าตัดนิ่วออกจากกระเพาะปัสสาวะ (E015)' },
              ],
            },
          ],
        },
