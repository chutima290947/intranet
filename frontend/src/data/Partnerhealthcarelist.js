...
export const HEALTHCARE_PARTNERS = [
...

  {
    ...
    contact: 'พนักงานสาขาที่ 00015 และ สาขาที่ 00018 และ สำนักงานใหญ่ เข้ารับบริการ โดยแสดงใบส่งตัวจากระบบของบริษัท ฯ ทางมือถือ (ใบส่งตัวอิเล็กทรอนิกส์)\n- เลขที่ใบส่งตัว EPT PK1 บมจ. เซ็นทรัลพัฒนา (สาขาที่ 00015) เซ็นทรัล เฟสติวัล ภูเก็ต\n- เลขที่ใบส่งตัว EPT PKT บมจ. เซ็นทรัลพัฒนา (สาขาที่ 00018) เซ็นทรัล ภูเก็ต ฟลอเรสต้า\n- เลขที่ใบส่งตัว EPT HOF บมจ. เซ็นทรัลพัฒนา (สำนักงานใหญ่) Payor Code : 6700520001\nเอกสารประกอบการวางบิล\n- ใบส่งตัว / ใบส่งตัวอิเล็กทรอนิกส์\n- สำเนาบัตรประชาชน / Passport\n- ใบรับรองแพทย์ / ใบเคลม\n- สำเนา Invoice ค่าใช้จ่ายส่วนแรก (พนักงานชำระเงินเอง 1,000 บาท) + Invoice ส่วนที่สอง วางบิลบริษัท\n- รายละเอียดค่ารักษาพยาบาล\nกรณีมีปัญหาติดต่อ คุณอุสาห์ มหาชัยชนะ (อุ๊) โทรศัพท์ 092 - 6543255',
    docs: [
      {
        label: 'รายละเอียด',
  ...
  },
  {
    ...
    contact: 'URL การตรวจสอบใบส่งตัวออนไลน์ : https:// yhcc-exp.yamaha-motor.co.th \nเอกสารประกอบการวางบิล \n- หนังสือส่งตัวพร้อมลายเซ็นพนักงาน \n- สำเนาบัตรประชาชน และ สำเนาบัตรพนักงาน \n- ใบรับรองแพทย์ / ใบเคลมหรือใบรายละเอียดค่ารักษาพยาบาล / ใบแจ้งหนี้ \nกรณีมีปัญหาติดต่อ คุณพรรณกร หนักแน่น (พันช์) โทรศัพท์ 064-9282228',
    docs: [
      {
        label: 'รายละเอียด',
  ...
  },
  {
    ...
    contact: 'เอกสารประกอบการวางบิล \n- ใบส่งตัว\n- สำเนาบัตรประชาชน / Passport\n- ใบรับรองแพทย์ / ใบเคลม\n- รายละเอียดค่ารักษาพยาบาล\nกรณีมีปัญหาติดต่อ กรณีมีปัญหาติดต่อ คุณพรรณกร หนักแน่น (พันช์) โทรศัพท์ 064-9282228',
    docs: [
      {
        label: 'รายละเอียด',
...

  {
   ...
   contact: 'เอกสารประกอบการวางบิล\nPayor Code : 6700775002 บจก. เซ็นทรัลเทรดดิ้ง\nPayor Code : 6780650047 บจก. ซีเทรคสากล\nPayor Code : 6780650048 บจก. เท็กซ์ทรัล เท็กซ์ไทลส์\nPayor Code : 6780650096 บจก. เอิร์ธแคร์\n- ใบส่งตัว\n- สำเนาบัตรประชาชน และ สำเนาบัตรพนักงาน\n- ใบรับรองแพทย์ / ใบเคลม\n- รายละเอียดค่ารักษาพยาบาล\nกรณีมีปัญหาติดต่อ คุณอุสาห์ มหาชัยชนะ (อุ๊) โทรศัพท์ 092 - 6543255',
    docs: [
      ...
      {
        label: 'แบบฟอร์มเอกสารใบส่งตัว(ผู้มีอำนาจลงนามเป็น HR ประจำบริษัท)',
        href: 'http://10.161.11.22/Images/Uploads/Marketing/New%20Patient%20Transfer%20Patient%20_Update.pdf',
      },
      {
        label: 'เอกสารสัญญา',
  ...
  },
  {
    ...
    contact: 'เอกสารประกอบการวางบิล\n- ใบส่งตัว\n- สำเนาบัตรประชาชน / Passport\n- ใบรับรองแพทย์ / ใบเคลม\n- รายละเอียดค่ารักษาพยาบาล\nกรณีมีปัญหาติดต่อ คุณธารฤปภา โชตะวัน (ตั๊ก) โทรศัพท์ 093-6392224',
    docs: [
      {
        label: 'รายละเอียด',
  ...
  },
  {
    ...
    docs: [
      ...
      {
        label: 'ระบบตรวจสอบสิทธิ์ออนไลน์',
